...
* **Get Support:** Report bugs and receive troubleshooting assistance
...
* Chimera: Chimera scripts
* Script Packages: Bundled projects with multiple files and resources, available as a ZIP
* Script Browser (web interface): Live search and filtering of all SPCLib scripts
...
* Feature Requests: Suggest new scripts or improvements
* Share your scripts in <#1409768360115437600>
* Submit Pull Requests: Contribute improvements, bug fixes, or new scripts via GitHub. See CONTRIBUTING.md for workflow and code style.

**How do I keep up with updates?**
* <#1409718980679303260> - GitHub commit feed

**Where can I chat or meet other users?**
* <#1409750370585935943> - General discussion about Halo/SPCLib
* Voice channels: General and In-Game for casual/gameplay conversations
